...
import com.icepanel.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncIcePanelClientBuilder {
     ...
     * Sets token
     */
    public AsyncIcePanelClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncIcePanelClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncIcePanelClientBuilder url(String url) {
     ...
     */
    public AsyncIcePanelClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncIcePanelClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncIcePanelClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncIcePanelClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncIcePanelClientBuilder addHeader(String name, String value) {
