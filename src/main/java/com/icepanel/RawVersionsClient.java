...
public class RawVersionsClient {
    ...
    public IcePanelClientHttpResponse<VersionsCreateResponse> create(VersionCreateRequest request) {
    ...
    public IcePanelClientHttpResponse<VersionsGetResponse> get(VersionFindRequest request) {
    ...
    public IcePanelClientHttpResponse<Object> delete(VersionDeleteRequest request) {
        return delete(request, null);
    }

    public IcePanelClientHttpResponse<Object> delete(VersionDeleteRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("landscapes")
                .addPathSegment(request.getLandscapeId())
    ...
    public IcePanelClientHttpResponse<VersionsUpdateResponse> update(VersionUpdateRequest request) {
