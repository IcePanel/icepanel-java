...
public class RawExportClient {
    ...
    public IcePanelClientHttpResponse<ExportGetResponse> get(DiagramExportImageFindRequest request) {
    ...
    public IcePanelClientHttpResponse<ExportCreateResponse> create(DiagramExportImageCreateRequest request) {
