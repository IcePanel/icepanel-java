...
public class AsyncRawExportClient {
    ...
    public CompletableFuture<IcePanelClientHttpResponse<String>> text(FlowExportTextRequest request) {
    ...
    public CompletableFuture<IcePanelClientHttpResponse<String>> code(FlowExportCodeRequest request) {
    ...
    public CompletableFuture<IcePanelClientHttpResponse<String>> mermaid(FlowExportMermaidRequest request) {
