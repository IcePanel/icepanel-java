...
public class RawImportClient {
     ...
     */
    public IcePanelClientHttpResponse<ImportCreateResponse> create(LandscapeImportRequest request) {
     ...
     * <p>The <code>JSONSchema</code> can be accessed at <code>api.icepanel.io/v1/schemas/LandscapeImportData</code> for automations or using LLMs for generation.</p>
     */
    public IcePanelClientHttpResponse<ImportCreateResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new IcePanelClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ImportCreateResponse.class), response);
            }
            try {
     ...
     */
    public IcePanelClientHttpResponse<ImportGetResponse> get(LandscapeImportGetRequest request) {
     ...
     * Get the status of a landscape import job.
     */
    public IcePanelClientHttpResponse<ImportGetResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new IcePanelClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ImportGetResponse.class), response);
            }
            try {
                switch (response.code()) {
                    case 400:
