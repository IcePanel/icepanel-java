...
public class RawLandscapesClient {
    ...
    public IcePanelClientHttpResponse<LandscapesListResponse> list(OrganizationLandscapesListRequest request) {
    ...
    public IcePanelClientHttpResponse<LandscapesCreateResponse> create(OrganizationLandscapeCreateRequest request) {
