...
public final class FlowsListRequest {
    ...
    public interface LandscapeIdStage {
        ...
        Builder from(FlowsListRequest other);
    }
    ...
    public interface _FinalStage {
        FlowsListRequest build();

        _FinalStage filter(Optional<FlowFilter> filter);

        _FinalStage filter(FlowFilter filter);
    }
    ...
    public static final class Builder implements LandscapeIdStage, VersionIdStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage filter(FlowFilter filter) {
        ...
        public _FinalStage filter(Optional<FlowFilter> filter) {
            this.filter = filter;
            return this;
        }
        ...
        public FlowsListRequest build() {
            return new FlowsListRequest(landscapeId, versionId, filter, additionalProperties);
        }
    }
}
